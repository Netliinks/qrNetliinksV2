...
export const getToken = async (mail, password) => {
    const URL = 'https://backendtest.netliinks.com:443/oauth/token';
    const ReqOptions = {
        method: 'POST',
...
export const getFile = async (fileUrl) => {
    const url = 'https://backendtest.netliinks.com:443/rest/files?fileRef=';
    const requestOptions = {
        method: 'GET',
        headers: headers,
        redirect: 'follow'
...
export const setFile = async (file) => {
    const url = `https://backendtest.netliinks.com:443/rest/files?name=${file.name}`;
    const requestOptions = {
        method: 'POST',
        headers: {
