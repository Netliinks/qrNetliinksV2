...
// GENERAL URL
// ===================================================
const NetliinksUrl: string = 'https://backendtest.netliinks.com:443/rest/entities/'
// ===================================================
...
export const getToken = async (mail: string, password: string): Endpoint => {
    const URL: string =
        'https://backendtest.netliinks.com:443/oauth/token'
...
export const getUserInfo = async (): Endpoint => {
    const userInfo: Request = {
        url: 'https://backendtest.netliinks.com:443/rest/userInfo?fetchPlan=full',
        method: 'GET'
    }
...
export const registerEntity = async (raw: any, type: string): Endpoint => {
    const req: Request = {
        url: 'https://backendtest.netliinks.com:443/rest/entities/',
        method: 'POST'
    }
...
export const setPassword = async (raw: string): Endpoint => {
    const req: Request = {
        url: 'https://backendtest.netliinks.com:443/rest/services/UserServiceBean/updatePassword',
        method: 'POST'
    }
...
export const setUserRole = async (raw: string): Endpoint => {
    const req: Request = {
        url: 'https://backendtest.netliinks.com:443/rest/services/UserServiceBean/assignRol',
        method: 'POST'
    }
...
export const sendMail = async (raw: string): Endpoint => {
    const req = {
        url: 'https://backendtest.netliinks.com:443/rest/services/UserServiceBean/sendByEmailInfo',
        method: 'POST'
    }
...
export const updateTokenVisit = async (id: string): Endpoint => {
    ...
    const req = {
        url: 'https://backendtest.netliinks.com:443/rest/services/UserServiceBean/updateTokenVisit',
        method: 'POST'
    }
...
export const getFile = async (fileUrl: string): Endpoint => {
    const url: string = 'https://backendtest.netliinks.com:443/rest/files?fileRef='
...
export const setFile = async (file: File): Endpoint => {
    const url: string = `https://backendtest.netliinks.com:443/rest/files?name=${file.name}`
