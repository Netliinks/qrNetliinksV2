...
import { getUserInfo, _userAgent, getEntityData, updateEntity } from "./endpoints.js"
    ...
    public showExpired(): void {
        ...
        <div class="login_window">
            <div class="login_header">
                ...
                <h1 class="login_title">PORTAL QR VISITA</h1>
                <div class="input_detail">
                    <label for="ingress-date"><i class="fa-solid fa-exclamation-circle" style="color:red;"></i> Fecha de visita expirada</label><br>
                </div>
                </div>
                <div class="login_content" style="display:flex;justify-content:center">
                <br>
